        ...
        <div id="carouselExampleIndicators" class="carousel slide my-4" data-ride="carousel">
            <div class="carousel-inner" role="listbox">
                <div class="carousel-item active">
                    ${requestScope.car.image}                        <img class="d-block img-fluid" src="image/${requestScope.car.image}" style="width: 100%; height: 700px;">
                </div>
                <c:forEach items="${requestScope.listImage}" var="i">
                    <div class="carousel-item">
                        <img class="d-block img-fluid" src="image/${i.name}" style="width: 100%; height: 700px;">
                    </div>
                </c:forEach>
            </div>
                    ...
                    <div class="sidebar_content">
                        ...
                        <div>
                            ...
                            <div id="respond" class="comment-respond">
                                ...
                                <form action="comment?carid=${requestScope.car.id}" method="post" id="commentform" >
                                    ...
                                    <c:if test="${sessionScope.user == null || (sessionScope.user != null && sessionScope.user.type == 2)}">
                                        <button class="button" style="width: 226.19px; height: 45.45px; margin: 25px;">
                                            <a href="login.jsp" style="color: #fff;">Sign in to renter account</a>
                                        </button>
                                    </c:if>
                                </form>
                            </div>
                                ...
                                <script>
                                    function validForm(action, id) {
                                        ...
                                        if (fromDate === currentDate) {
                                            ...
                                            document.f.action = "author?action=" + action + "&carid=" + id;
                                            document.f.submit();
                                        }
                                    }
