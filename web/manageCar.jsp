...
<html lang="en-US" data-menu="leftalign">
    ...
    <body>
        <c:if test="${requestScope.listCar == null}">
            ...
            <% request.setAttribute("href", "add.jsp");%>
                ...
                <c:if test="${requestScope.listCar != null}">
                    <c:forEach items="${requestScope.listCar}" var="c">
                        <div class="element portfolio_type">
                            <a  href="manageCar?action=edit&id=${c.id}">
                                <img src="image/${c.image}" style="height: 346.29px;"/>
                            </a>
                            <div class="portfolio_info_wrapper" >
                                <div class="car_attribute_wrapper" style="margin-bottom: 10px;">
                                    <h2>${c.brand} ${c.model}</h2>
                                    <button class="button" style="width: 150px;"><a href="author?action=editCar&id=${c.id}" style="color: #fff;">Edit</a></button>
                                </div>
