    ...
    <div id="wrapper" class="hasbg transparent">
        ...
        <c:if test="${requestScope.car != null}">
            ...
            <div id="carouselExampleIndicators" class="carousel slide my-4" data-ride="carousel">
                <div class="carousel-inner" role="listbox">
                    <div class="carousel-item active">
                        <img class="d-block img-fluid" src="image/${requestScope.car.image}" style="width: 100%; height: 700px;;">
                    </div>
            ...
            <div id="page_content_wrapper" class="hasbg withtopbar ">
                <form action="manageCar" method="post"  encType="multipart/form-data">
                    ...
                    <c:if test="${requestScope.isValidDelete}">
                        <button class="button" style="width: 270px;"><a href="manageCar?action=delete&id=${requestScope.car.id}" style="color: #fff;">Delete</a></button>
                    </c:if>
                    <c:if test="${!requestScope.isValidDelete}">
