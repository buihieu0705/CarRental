...
public class AccountDAO extends DBContext<Account> {
    ...
    public Account getAcount(String username, String password, int type) {
        try {
            String sql;
            ...
            if (rs.next()) {
                return new Account(username, password, rs.getInt("accounttype"),
                        rs.getString("fullname"), rs.getString("email"),
                        rs.getString("address"), rs.getString("city"),
                        rs.getInt("phone"));
            }
        } catch (SQLException e) {
            System.out.println("getAcount " + e);
        }
        return null;
    }

    public boolean existedEmail(String email, String username, int type) {
        //Type:
        //1: register
        //2: profile
        try {
            ...
            System.out.println("existedEmail " + e);
        }
        return false;
    }
